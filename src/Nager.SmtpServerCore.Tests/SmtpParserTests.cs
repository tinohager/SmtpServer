...
namespace Nager.SmtpServerCore.Tests
{
    ...
    {
        //static SequenceReader<byte> CreateReader(string text)
        //{
        //    var buffer = Encoding.UTF8.GetBytes(text);

        //    //return new TokenReader(new ReadOnlySequence<byte>(buffer, 0, buffer.Length));
        //    var buffer2 = new ReadOnlySequence<byte>(buffer);
        //    return new SequenceReader<byte>(buffer2);
        //}

        static ReadOnlySequence<byte> CreateReader1(string text)
        {
            var buffer = Encoding.UTF8.GetBytes(text);
        ...
        {
            // arrange
            var reader = CreateReader1("QUIT\r\n");

            // act
            var result = Parser.TryMake(ref reader, out var command, out var errorResponse);
        ...
        {
            // arrange
            var reader = CreateReader1("HELO abc-1-def.mail.com\r\n");
        ...
        {
            // arrange
            var reader = CreateReader1(input);
        ...
        {
            // arrange
            var reader = CreateReader1("AUTH PLAIN Y2Fpbi5vc3VsbGl2YW5AZ21haWwuY29t\r\n");
        ...
        {
            // arrange
            var reader = CreateReader1("AUTH LOGIN Y2Fpbi5vc3VsbGl2YW5AZ21haWwuY29t\r\n");
        ...
        [Theory]
        [InlineData("MAIL FROM:<cain.osullivan@gmail.com>\r\n", "cain.osullivan", "gmail.com")]
        [InlineData(@"MAIL FROM:<""Abc@def""@example.com>\r\n", "Abc@def", "example.com")]
        [InlineData("MAIL FROM:<pelé@example.com> SMTPUTF8\r\n", "pelé", "example.com", "SMTPUTF8")]
        ...
        {
            // arrange
            var reader = CreateReader1("MAIL FROM:<>\r\n");
        ...
        [InlineData(@"RCPT TO:<""Abc@def""@example.com>\r\n", "Abc@def", "example.com")]
        [InlineData("RCPT TO:<pelé@example.com>\r\n", "pelé", "example.com")]
        [InlineData("RCPT TO:<@example1.com:someone@example.com>\r\n", "someone", "example.com")]
        [InlineData("RCPT TO:<@example1.com,@example2.com:someone@example.com>\r\n", "someone", "example.com")]
        [InlineData("RCPT TO:<example/example@example.com>\r\n", "example/example", "example.com")]
        ...
        public void CanNotMakeRcpt(string input)
        {
            ...
            // act
            var result = Parser.TryMake(ref reader, out _, out _);
